...
BASE_DOMAIN = "https://yt.hosters.club"  # Updated to match cURL command
...
# Main endpoint with X-API-Key header support
@app.get("/")
...
# YouTube ID endpoint with X-API-Key header support
@app.get("/yt")
...
# Corrected background_instagram_download
